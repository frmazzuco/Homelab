...
- `terraform/oracle/`: Infra OCI (rede, instancia, outputs, cloud-init). Ver `terraform/oracle/README.md`.
...
```
Use `terraform/oracle/README.md` e `terraform/oracle/terraform.tfvars.example` como referencia
